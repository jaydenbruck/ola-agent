...
SITE_FACTS: dict[str, dict[str, str]] = {
    ...
    "lieferando.de": {
        ...
        "facts": (
            ...
            "Demo restaurant: 'Restaurant Pizzeria Roma' (Schulstraße 66, 63329 Egelsbach; delivers to Dreieich), menu "
            "https://www.lieferando.de/speisekarte/restaurant-pizzeria-roma-63329 , usual item 'Pizza Prosciutto' with 'Knoblauch' (garlic) extra; after adding it to the cart, proceed to the CHECKOUT page (delivery address + payment visible) and only there call confirm(title, price, delivery time); free delivery "
            "from 15 EUR; it delivers to Musterstraße 12 (same Offenthal district). The ham pizza is the "
