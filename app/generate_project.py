...
obj(3, f'isa = PBXGroup; children = ({", ".join(source_refs)}, {ident(20)}); path = Ola; sourceTree = "<group>";')
...
obj(9, f'isa = PBXResourcesBuildPhase; buildActionMask = 2147483647; files = ({ident(23)}); runOnlyForDeploymentPostprocessing = 0;')
...
target = 'CODE_SIGN_STYLE = Automatic; CURRENT_PROJECT_VERSION = 1; GENERATE_INFOPLIST_FILE = NO; INFOPLIST_FILE = Ola/Info.plist; PRODUCT_BUNDLE_IDENTIFIER = ai.tryola.submission; PRODUCT_NAME = "$(TARGET_NAME)"; TARGETED_DEVICE_FAMILY = 1; SUPPORTED_PLATFORMS = "iphoneos iphonesimulator"; SUPPORTS_MACCATALYST = NO; SWIFT_EMIT_LOC_STRINGS = YES;'
